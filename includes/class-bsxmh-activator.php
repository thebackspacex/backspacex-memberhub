...
final class BSXMH_Activator {
    ...
    private static function add_default_options(): void {
        $defaults = array(
            ...
            'default_membership_fund_id' => 0,
            'default_registration_role' => 'bsxmh_member',
            'member_id_prefix' => 'MH',
            'registration_enabled' => 1,
            'registration_requires_approval' => 1,
            'registration_description' => 'Create your member account using the form below.',
            'login_description' => 'Log in to access your member dashboard.',
            'public_dashboard_visibility' => 'members',
